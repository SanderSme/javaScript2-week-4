            ...
            <li class="relative px-4 py-5 bg-white gap-y-4 flex flex-col">
                <div class="flex justify-between space-x-3">
                    <div class="flex-1 min-w-0">
                        <a href="../single-post.html?post_id=${posts[i].id}" class="block focus:outline-none">
                ...
                <div class="flex gap-4">
                    <button
                        ...
                        <a href="/edit-post.html?post_id=${posts[i].id}" class="delete-post-btn inline-flex items-center rounded-md border border-transparent bg-blue-100 px-3 py-2 text-sm font-medium leading-4 text-blue-700 hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Edit</a>
                </div>
            </li>
            `;
      }
